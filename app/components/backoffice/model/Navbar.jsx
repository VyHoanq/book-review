            ...
            <div className='flex space-x-3 relative'>
                ...
                >
                    ...
                    {isProfileDropdownOpen && (
                        <div className="absolute right-0 mt-2 w-25 bg-white text-black rounded-md shadow-lg z-50">
                            <button href="/profile" className="block px-6 py-4 text-sm hover:bg-gray-200">Dashboard</button>
                            <button href="/settings" className="block px-6 py-4 text-sm hover:bg-gray-200">Settings</button>
                            <button href="/logout" className="block px-6 py-4 text-sm hover:bg-gray-200">Logout</button>
                        </div>
                    )}
                </div>
            </div>
