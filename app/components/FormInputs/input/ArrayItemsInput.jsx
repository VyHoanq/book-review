                    ...
                    (
                        <div className="flex items-center mx-auto">
                            ...
                            <button
                                ...
                                className='shrink-0 ml-3 w-8 h-8 bg-red-500 rounded-full flex items-center justify-center' >
                                <X className='w-4 h-4 ' />
                            </button>
                        </div>
                    ) :
                    ...
                    items.map((item, index) => {
                        return (
                            <div
                                ...
                                key={index} className='bg-slate-200 text-slate-800 flex cursor-pointer rounded-lg dark:bg-slate-600 dark:text-slate-300 space-x-2 items-center px-4 py-2'>
                                <p>{item}</p>
                                <X className='h-4 w-4' />
                            </div>
                        )
